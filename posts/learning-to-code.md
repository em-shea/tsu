---
id: learning-to-code
title: Tips & resources for learning to code
category: Code
status: published
...
![Process collage](./learning-to-code/process-collage.png)
<p style="font-style:italic;text-align:center;font-size:15px;">My learning process, featuring The Bachelorette and <a href="https://syvarth.com/">rsyvarth</a>.</p>

##### Jump to:

- [Why learn to code](#why-learn-to-code)
- [Which language to choose](#which-language-to-choose)
- [Where to start](#where-to-start)
- [General tips](#general-tips)
  - [1. Build while you learn](#1-build-while-you-learn)
  - [2. Get good at asking questions](#2-get-good-at-asking-questions)
...
If you're looking to build personal projects, there's a chance you may be able to use no-code tools (👋 hello [Amazon Honeycode](https://www.honeycode.aws/)). If a no-code tool works for you and saves you time, by all means use it. 
...
Now that you have a goal in mind and your first programming language picked out, it's time to get started. I enjoyed the **free online courses from [Codecademy](www.codecademy.com) for [Python](https://www.codecademy.com/learn/learn-python) and [JavaScript](https://www.codecademy.com/learn/introduction-to-javascript)**. These courses are hands on and interactive, which helped me get a foundational understanding of the syntax and components of the languages. 

> Note: Python 2 is an older version of Python than the current version (3). It looks like Codecademy's Python 2 course is free, while their Python 3 course is paid. Given that the differences between Python 2 and 3 are fairly minimal at the beginner level, you could still take the Python 2 course, learn a bit about the [version differences](https://www.geeksforgeeks.org/important-differences-between-python-2-x-and-python-3-x-with-examples/) (namely, `print 'hello'` vs. `print('hello')`), and start coding in Python 3 without issues.

To get more exposure to the language and get into more advanced topics, I read the **O'Reilly books [Introducing Python](https://www.oreilly.com/library/view/introducing-python/9781449361167/) and [Head First JavaScript Programming](https://www.oreilly.com/library/view/head-first-javascript/9781449340124/)**. The Python book was excellent. The JavaScript book was a little quirky, but got the job done.
...
If you read another post of mine, [Getting started with serverless on AWS](https://emshea.com/post/serverless-getting-started), you can see how my learning path for serverless closely parallels mine for programming. For nearly every project, I needed to build a new programming skill. The first project is a no-code static website, the next two use beginning JavaScript and beginning Python, and the later projects are more complex and required significantly more code.
...
Few things are more frustrating than running into a programming problem that you just can't figure out how to solve. This is when it's helpful to have back-up! 
  ...
  - **Coding meetups.** Pre-COVID 19, I attended Meetup events for developers, like [Puget Sound Programming Python (PuPPy)](https://www.meetup.com/PSPPython/). Hopefully we'll get this back someday! I know many groups are still doing virtual events.
